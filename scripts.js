...
vgsPlayer.poster('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3F2LLf2cCnLbSJ4VvpP3Ibex1deqNu18wJg&usqp=CAU');
...
function vsgLoadVideo(vidURL, poster) {
    ...
    if (poster)
        ...
        vgsPlayer.poster("//i.imgur.com/aE0LoTe.");
